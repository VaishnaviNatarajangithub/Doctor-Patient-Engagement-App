...
const AddDoctor = () => {
    ...
    const { data } = await axios.post(
      ...
      {
        headers: {
          atoken: aToken // send your token exactly like this
        }
      }
    );
  ...
  return (
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <input onChange={(e)=> setDocImg(e.target.files[0])} type="file" id="doc-img" name="image"  hidden />
      ...
      <div className='flex-1 flex flex-col gap-1'>
        <p>Experience</p>
        <select onChange={(e)=> setExperience(e.target.value)} value={experience} name="" >
